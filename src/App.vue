      ...
      <details class="collapsible-section" open>
        ...
        <div class="control-group">
          <div class="template-actions">
            ...
            <button class="btn btn-sm" id="tpl-import" :title="t('import_code')">
              {{ t("import_code") }}
            </button>
          </div>
        </div>
  ...
  <footer class="global-footer">
    <div class="footer-content">
      ...
      <span class="footer-links">
        <a href="https://github.com/yandujun363/pv-tool-agpl" target="_blank" rel="noopener noreferrer">{{
          t("license_source") }}</a>
        <a href="https://www.gnu.org/licenses/agpl-3.0.txt" target="_blank" rel="noopener noreferrer">AGPL-3.0</a>
      </span>
    </div>
  </footer>
</template>
