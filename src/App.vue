  ...
  <div class="panels-wrapper" id="panels-wrapper">
    <div class="controls">
      <details class="collapsible-section" open>
        ...
        <div class="control-group">
          ...
          <div
            id="tpl-delete-confirm"
            class="tpl-inline-input"
            style="display: none"
          >
        ...
        <div class="control-group">
          ...
          <textarea
            id="text-input"
            rows="1"
            placeholder="深夜東京/の6畳半夢/を見てた/灯りの灯らない蛍光灯/明日には消えてる電脳城/に/開幕戦/打ち上げて/いなくなんないよね/ここには誰もいない/ここには誰もいないから"
          ></textarea>
        </div>
        ...
        <div class="control-group">
          <label
            >{{ t("bg_opacity") }} <span id="opacity-val">100%</span></label
          >
          <input
            type="range"
            id="opacity-slider"
      ...
      <details class="collapsible-section" open>
        ...
        <div class="control-group">
          <label class="effect-toggle nwc-toggle-row">
            ...
            <span class="help-tip" :data-tip="t('listen_wesingcap_tip')"
              >?</span
            >
            <button
              type="button"
    ...
    >
      <details class="collapsible-section" open>
        ...
        <div class="control-group">
          <div class="template-actions">
            <button class="btn btn-sm" id="tpl-save" :title="t('save_tpl')">
              {{ t("save_tpl") }}
            </button>
            <button
              class="btn btn-sm"
        ...
        <div class="control-group" id="tpl-save-input" style="display: none">
          <div class="tpl-inline-input">
            ...
            />
            <button class="btn btn-sm" id="tpl-save-ok">
              {{ t("confirm") }}
            </button>
            <button class="btn btn-sm" id="tpl-save-cancel">
              {{ t("cancel") }}
            </button>
          </div>
        </div>
        <div class="control-group" id="share-code-group" style="display: none">
          ...
          />
          <div class="template-actions">
            <button class="btn btn-sm" id="share-code-ok">
              {{ t("confirm") }}
            </button>
            <button class="btn btn-sm" id="share-code-cancel">
              {{ t("cancel") }}
            </button>
          </div>
        </div>
        <div id="effect-grid">
          <template v-for="(items, cat) in effectCategories" :key="cat">
            <details class="effect-category" open>
              <summary class="effect-category-title">
                {{ t(`ecat_${cat}`) || cat }}
              </summary>
